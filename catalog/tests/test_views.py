...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user1.save()
        test_user2 = User.objects.create_user(username='testuser2', password='12345678ASD') 
        test_user2.save()
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2.save()
        permission = Permission.objects.get(codename='catalog.can_mark_returned')
        test_user2.user_permissions.add(permission)
        test_user2.save()
        permission = Permission.objects.get(codename='catalog.can_see_borrowed')
        test_user2.user_permissions.add(permission)
        test_user2.save()
